...
#[inline]
pub fn matrix_product(alpha: f64, A: &[f64], B: &[f64], beta: f64, C: &mut [f64], m: usize,
                      p: usize, n: usize) {
...
#[inline]
pub fn scalar_product(X: &[f64], Y: &[f64], n: usize) -> f64 {
...
#[inline]
pub fn scaling(alpha: f64, X: &mut [f64], n: usize) {
    debug_assert_eq!(X.len(), n);
...
#[inline]
pub fn summation(alpha: f64, X: &[f64], Y: &mut [f64], n: usize) {
    debug_assert_eq!(X.len(), n);
    debug_assert_eq!(Y.len(), n);
...
mod tests {
    ...
    fn matrix_product() {
        ...
        super::matrix_product(1.0, &A, &B, 1.0, &mut C, m, p, n);
    ...
    #[test]
    fn scalar_product() {
        assert::equal(super::scalar_product(&[10.0, -4.0], &[5.0, 2.0], 2), 42.0);
    }
